...
const CategoryCard = ({ title, images, btnLink }) => {
    ...
    return (
        <div className="relative w-[30rem] min-w-[30rem] h-[40rem] overflow-hidden group ">
            ...
            <div className="text-center absolute inset-0 bg-black bg-opacity-20 lg:bg-opacity-40 flex flex-col justify-center items-center text-white p-4 transition-colors duration-300 group-hover:bg-opacity-15 ">
                ...
                {btnLink && (
                    <Link href={btnLink} className="mt-4 px-4 py-1 bg-accent bg-opacity-50 text-primary rounded-xl group-hover:text-lg hover:bg-accent-dark active:bg-accent transition-colors duration-300 inline-flex items-center gap-1">
